...
def generateVehicles():
    # CARRIL DE ARRIBA (direction 'up')
    for _ in range(4):
        Vehicle(2, 'car', 1, 'down', 1)  # 12 coches hacia el carril izquierdo

    # CARRIL DE ABAJO (direction 'down')
    for _ in range(1):
        Vehicle(2, 'car', 3, 'up', 1)  # 2 coches hacia el carril derecho
    for _ in range(6):
        Vehicle(1, 'car', 3, 'up', 3) 
    for _ in range(5):
        Vehicle(2, 'car', 3, 'up', 3)  # 17 coches hacia el carril de arriba
    

    # CARRIL DE LA DERECHA (direction 'right')
    for _ in range(15):
        Vehicle(2, 'car', 0, 'right', 2)  # 160 coches hacia el carril derecho
    for _ in range(15):
        Vehicle(1, 'car', 0, 'right', 2)  # 160 coches hacia el carril derecho

    # CARRIL DE LA IZQUIERDA (direction 'left')
    for _ in range(28):
        Vehicle(1, 'car', 2, 'left', 3)  # 135 coches hacia el carril izquierdo
    for _ in range(3):
        Vehicle(2, 'car', 2, 'left', 1)  # 8 coches hacia el carril de arriba (giro a la derecha)
    for _ in range(19):
        Vehicle(2, 'car', 2, 'left', 3)  # 135 coches hacia el carril izquierdo
...
class Main:
    ...
    background = pygame.image.load('images/avingudab.png')

    screen = pygame.display.set_mode(screenSize)
    pygame.display.set_caption("Simulacio")
    ...
    while True:
        ...
        timeElapsedText = font.render(("Temps: "+str(timeElapsed)), True, black, white)
